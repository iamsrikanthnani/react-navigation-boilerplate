...
import {RNText, Photo} from 'components/common';
  ...
  return (
    <TouchableOpacity style={styles.itemContainer} onPress={onChatPress}>
      ...
      <View style={styles.itemMessageContainer}>
        <RNText font="semibold">{item.name}</RNText>
        <View style={styles.itemTimeContainer}>
          ...
          <RNText font="medium">{item.createdAt}</RNText>
        </View>
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    <TouchableOpacity
      ...
      <Photo
        ...
        delay={1500}
      />
      <RNText font="semibold" numberOfLines={2} style={styles.headerItemName}>
        {item.name}
      </RNText>
    </TouchableOpacity>
  );
